...
- **Pharmacists / stock managers** receive goods, manage batches, and track expiry dates
- **Accountants / managers** review financials, process payroll, and monitor daily performance
...
### Accounting & Ledger
The accounting module keeps a double-entry ledger automatically updated by sales and expenses. You can view the master ledger, cash-flow statement, revenue breakdown, and expense summary. Manual journal entries are supported for adjustments. Reconciliation marks periods as closed.

### Assets, Prepaids & Receivables
Track fixed assets (equipment, furniture) with depreciation schedules and revaluation history. Record prepaid expenses and amortize them over their coverage period. Log receivable invoices owed to the pharmacy and record payments as they come in. Manage liabilities such as loans or taxes and track repayment schedules.
...
### Help System
A built-in help window provides bilingual documentation (English and Amharic) covering every feature. You can browse by section or search by keyword.
